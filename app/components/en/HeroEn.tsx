        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            ...
            <div className="flex gap-3 md:gap-4">
              <a href="#projects" className="px-5 md:px-7 py-3 bg-teal-900 text-white text-sm tracking-wide hover:bg-teal-700 transition-colors rounded-sm">
                View projects
              </a>
              <a href="#contact" className="px-5 md:px-7 py-3 border border-teal-900 text-teal-900 text-sm tracking-wide hover:bg-teal-50 transition-colors rounded-sm">
                Contact
              </a>
            </div>
          </motion.div>
