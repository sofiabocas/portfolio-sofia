...
const proyectos = [
  {
    ...
    descripcion: "Diseñé y desarrollé un sistema ERP completo para centralizar la operación de un restaurante y negocio de delivery. Reemplazó hojas de Excel dispersas, centralizando ventas, egresos, pedidos, caja, fidelización y liquidaciones de apps de delivery.",
    ...
    conclusion: "El sistema redujo errores de registro en un 50%, eliminó la dependencia de Excel como base de datos y permitió visualizar KPIs del negocio de forma inmediata desde cualquier dispositivo.",
    herramientas: ["Next.js", "PostgreSQL", "React", "TypeScript", "Vercel"],
   imagen: "/proyectos/sukeen.png",
    color: "from-teal-800 to-blue-800",
    destacado: true,
    modulos: ["Dashboard KPIs", "Pedidos", "Ventas", "Egresos", "Caja", "Apps delivery", "Cocina", "Deudores", "Ranking", "Fidelización"],
  },
  {
    id: 2,
